...
function prepareUpdate(clickedButton){
  ...
  formInputs[0].value = expenseFields[2].dataset.categoryId;
  formInputs[0].previousElementSibling.previousElementSibling.textContent = expenseFields[2].textContent;
  formInputs[1].value = expenseFields[3].dataset.subcategoryId;
  formInputs[1].previousElementSibling.previousElementSibling.textContent = expenseFields[3].textContent;
  formInputs[2].value = expenseFields[0].textContent;
  formInputs[2].textContent = expenseFields[0].textContent;
  formInputs[3].value = expenseFields[4].textContent;
  formInputs[4].value = expenseFields[5].textContent;
