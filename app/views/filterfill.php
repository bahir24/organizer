            ...
            <div class="form-group mb-1">
              <div class="input-group">
                <div class="btn-group dropright w-100 btn-group-subcategory">
                   <button type="button" class="btn btn-outline-primary btn-sm dropdown-toggle btn-category" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" disabled onclick="sortSubcategories(this.closest('.form-group').previousElementSibling.querySelector('.dropdown-menu').children[0])">
