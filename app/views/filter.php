<section class="all-expense">
                    ...
                    <div class="col-3">
                        ...
                        <div class="form-group mb-1">
                            <input type="date" form="filterQuery" name="startPurchaseDate"
                                class="form-control form-control-sm" id="startPurchaseDate" value="<?php if ($this->arrFilter->startPurchaseDate) {echo $this->arrFilter->startPurchaseDate;}?>">
                        </div>
                        <div class="form-group mb-1">
                            <input type="date" form="filterQuery" name="endPurchaseDate"
                                class="form-control form-control-sm" id="endPurchaseDate" value="<?php if ($this->arrFilter->endPurchaseDate) {echo $this->arrFilter->endPurchaseDate;}?>">
                        </div>
                    </div>
                    <div class="col-3">
                    </div>
    ...
    echo "Категория";
                        ...
                        <div class="form-group mb-1">
                            <div class="input-group">
                                <div class="btn-group dropright w-100 btn-group-subcategory">
                                    <button type="button"
                                        class="btn btn-outline-primary btn-sm dropdown-toggle btn-category"
                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" <?php if (!$this->arrFilter->categoryId) {
                        echo 'disabled';
                    }?>
                    ...
                    <div class="col-3">
                        ...
                        <div class="form-group mb-1">
                            <input type="text" form="filterQuery" class="form-control form-control-sm" id="startPrice"
                                placeholder="От" name="startPrice" value="<?php if ($this->arrFilter->startPrice) {
                        echo $this->arrFilter->startPrice;
                    }?>">
                        </div>
                        <div class="form-group mb-1">
                            <input type="text" form="filterQuery" class="form-control form-control-sm" id="endPrice"
                                placeholder="До" name="endPrice" value="<?php if ($this->arrFilter->endPrice) {
                ...
                <input type='hidden' name='order' class='order'
                    value="<?php echo $this->arrFilter->order;?>">
                <input type='hidden' name='orderField' class='orderField'
                    value="<?php echo $this->arrFilter->orderField;?>">
            </form>
            <?php
