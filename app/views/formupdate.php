<div class="modal fade" id="updateExpense" tabindex="-1" role="dialog" aria-labelledby="updateExpenseTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="w-100" action="main/updateExpense" name="updateExpense" method="POST"
                    id="formUpdateExpense">
                ...
                ?>
                    ...
                    <div class="input-group mb-2">
                        <label class="streched">
                            ...
                            <input type="date" form="formUpdateExpense" name="purchaseDate"
                                class="form-control expense-day"
                    ...
                    <div class="input-group mb-2">
                        <label class="streched">
                            ...
                            <div class="d-flex">
                                <input type="text" form="formUpdateExpense" name="price"
                                    class="form-control input-calc">
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="updateButton();" form="formUpdateExpense"
                    class="btn btn-success btn-lg">Записать</button>
            </div>
        </div>
    </div>
</div>